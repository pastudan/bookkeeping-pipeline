...
const openDirectives = finalEntries
  .map((e) => `1900-01-01 open ${e.beancountAccount.padEnd(45)} USD`)
  .join("\n");
...
1900-01-01 open Equity:Opening                                USD
  description: "Balancing account for opening entry"
...
console.log("  1. Review opening.beancount — check account names make sense");
console.log("  2. If any account names are wrong, add --map account-map.json to override");
console.log(`  3. Add 'include \"opening.beancount\"' to main.beancount`);
